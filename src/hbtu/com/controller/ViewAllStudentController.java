	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Statement stmt=null;
		  try{
			 ...
			 String query="select * from student where isAdmited='yes' order by rollno";
          ...
          RequestDispatcher dispatcher=request.getRequestDispatcher("show-student-admitted.jsp");
