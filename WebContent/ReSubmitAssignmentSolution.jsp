...
<head>
    ...
    <title>ReSubmit Assignment Solution</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        <h1 class="heading">Assignment Submission</h1>
        <form action="ReSubmitAssignmentSolutionService" method="post" enctype="multipart/form-data">
